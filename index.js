...
async function getData() {
    ...
    if (userId) {
        try {
            const response = await fetch(`https://milionar-backend.onrender.com:10000/user/${userId}`);
            if (response.ok) {
...
async function login() {
    ...
    try {
        const res = await fetch('https://milionar-backend.onrender.com:10000/login', {
            method: 'POST',
...
async function signup() {
    ...
    try {
        const res = await fetch('https://milionar-backend.onrender.com:10000/register', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function fetchQuestion() {
    try {
        const res = await fetch('https://milionar-backend.onrender.com:10000/question');
...
async function updateMoney(amount) {
    try {
        ...
        const res = await fetch('https://milionar-backend.onrender.com:10000/update-money', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
